package basics;
// I feel like I've created a bit of a boolean hell hole here 
// but this is how I have split my original logic into small methods
// without first looking at your version

import java.util.Scanner;

public class password2 { 
	// use the scanner to make testing quicker
	...
	public static void main(String[] args) { //mm
	   ...
	   // 
	   // primary application method returning success or failure to the console
	   //
		 boolean goodPassword = verifyPassword(userPassword);
		 if(goodPassword) {
	...
	static boolean verifyPassword(String userPassword) {
		// 
